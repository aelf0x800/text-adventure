namespace TextAdventure
{
    internal class Game
    {
        ...
        public void Play()
        {
            ...
            {
                int gameEvent = _random.Next((int)GameEvent.Loot, (int)GameEvent.Dragon + 1);
                switch (gameEvent)
                {
                    case 1:
                        LootFound();
        ...
        private void DragonFound() 
        {
            ...
            while (dragon.Health > 0 && _player.Health > 0)
            {
                ...
                if (choice == 'a')
                {
                    ...
                    {
                        MessageBox("You have no weapons! This battle is already decided!");
                    }
                ...
                else
                {
                    ...
                    {
                        MessageBox("You have no consumables!");
                    }   
                }
            }
